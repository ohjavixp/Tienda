<%@ Page Title="" Language="C#" MasterPageFile="~/PrincipalBootstrap.Master" AutoEventWireup="true" CodeBehind="searchresults.aspx.cs" Inherits="PlataformaComercio.Web.vcatalogo.searchresults" %>
<%@ Register src="~/webcontrols/ProductDisplay.ascx" tagname="ProductDisplay" tagprefix="uc1" %>
<%@ Register src="../webcontrols/MessageControl.ascx" tagname="MessageControl" tagprefix="uc2" %>
